...
def conditioning_augmentation(x):
	...
	#args:x: The output of the text embedding passed through a FC layer with LeakyReLU non-linearity.

	#theReturns:c: The text conditioning variable after computation.
...
def UpSamplingBlock(x, num_kernels):
	...
	#Args:x: The preceding layer as input. num_kernels: Number of kernels for the Conv2D layer.

	#Returns:x: The final activation layer after the Upsampling block.
...
def build_stage1_discriminator():
	...
	#Returns:Stage 1 Discriminator Model for StackGAN.
...
def build_adversarial(generator_model, discriminator_model):
    #Stage 1 Adversarial model.Args:
...
def load_data(filename_path, class_id_path, dataset_path, embeddings_path, size):
	...
	data_dir = "C:/Users/bansa/Desktop/stackgan/birds"
	...
	dataset_path = "C:/Users/bansa/Desktop/stackgan/CUB_200_2011"
